...
Pros:
Simple Load Balancing ,More Efficient and Faster, only one TCP Connection

Cons:
No Smart load balancing , No Caching, Not Applicable for Microservices
...
Pros:
Smart load balancing (reading request and selecting suitable application server) ,Caching, Suitable for Microservices

Cons:
More Expensive , Two TCP Connections
